...
import com.example.citypass.cotroller.fragment.toutiao.CityjustActivity;
...
public class Just_Adapter extends RecyclerView.Adapter<Just_Adapter.MyViewHolder> {
    private List<Socbean.ServerInfoBean.ReplyInfoBean> mList;
    private Context context;

    public Just_Adapter(List<Socbean.ServerInfoBean.ReplyInfoBean> mList, Context context) {
        this.mList = mList;
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.onclick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(context, CityjustActivity.class);
