...
public class Square_NaoNao_Recycle_Adapter extends RecyclerView.Adapter<Square_NaoNao_Recycle_Adapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.square_naonao_recycle_item, null);
...
//            myGridLayout.setmList(strList);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View v) {
            ...
            myGridLayout = (LinearLayout) v.findViewById(R.id.square_naonao_recycle_item_img_one);
