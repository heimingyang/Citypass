...
public class Belle_Ly_Adapter extends RecyclerView.Adapter<Belle_Ly_Adapter.MyLyHolder> {
    private List<Belle_Ly_Bean.ServerInfoBean.CoverPhotoDetailsInfoBeanX.CoverPhotoDetailsInfoBean> mlist;
    private Context mcontext;

    public Belle_Ly_Adapter(List<Belle_Ly_Bean.ServerInfoBean.CoverPhotoDetailsInfoBeanX.CoverPhotoDetailsInfoBean> mlist, Context mcontext) {
        this.mlist = mlist;
        this.mcontext = mcontext;
    }

    public void setMlist(List<Belle_Ly_Bean.ServerInfoBean.CoverPhotoDetailsInfoBeanX.CoverPhotoDetailsInfoBean> mlist) {
        this.mlist = mlist;
    }

    @Override

    public MyLyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(mcontext).inflate(R.layout.zuixin_item, null);
        MyLyHolder myxinHolder = new MyLyHolder(inflate);
