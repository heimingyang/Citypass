 ...
 * 修改时间:
 */
public class ZhiDeYiKanAdapter extends RecyclerView.Adapter<ZhiDeYiKanAdapter.ViewHolder> implements View.OnClickListener{

    private List<ZhiDeYiKanBean.ServerInfoBean> data;
    private Context context;
    public ZhiDeYiKanAdapter(Context context,List<ZhiDeYiKanBean.ServerInfoBean> data){
