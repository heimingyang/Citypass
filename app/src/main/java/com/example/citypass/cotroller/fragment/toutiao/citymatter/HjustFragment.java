...
import com.example.citypass.cotroller.adapter.toutiao.Just_Adapter;
...
public class HjustFragment extends BaseFragment {
    ...
    protected void initView(View view) {
        ...
        socRecycler.setFootView(footview);

        mList = new ArrayList<>();
        //请求数据
        getdata(page);
        adapter = new Just_Adapter(mList,getActivity());
