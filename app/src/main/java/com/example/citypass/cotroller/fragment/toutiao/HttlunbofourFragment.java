...
public class HttlunbofourFragment extends BaseFragment {
    @BindView(R.id.fourlunbotv1)
    TextView fourlunbotv1;
    Unbinder unbinder;
    ...
    protected int getLayoutId() {
        ...
        return R.layout.httlunbofourfragment;
    }
