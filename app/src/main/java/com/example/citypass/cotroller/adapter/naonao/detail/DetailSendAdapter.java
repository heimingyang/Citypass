...
public class DetailSendAdapter extends RecyclerView.Adapter<DetailSendAdapter.mViewHolder> {
    private List<DetailSendBean.ServerInfoBean> mList;
    private Context context;

    public DetailSendAdapter(List<DetailSendBean.ServerInfoBean> mList, Context context) {
        this.mList = mList;
...
//得到地址
        ...
        holder.mDengjiText.setText(String.valueOf(level));
