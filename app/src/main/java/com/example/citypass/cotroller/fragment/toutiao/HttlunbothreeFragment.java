...
public class HttlunbothreeFragment extends BaseFragment {
    @BindView(R.id.threelunbotv1)
    TextView threelunbotv1;
    Unbinder unbinder;
    ...
    protected int getLayoutId() {
        ...
        return R.layout.httlunbothreefragment;
    }
