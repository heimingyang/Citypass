...
public class Belle_Mmz_Adapter extends RecyclerView.Adapter<Belle_Mmz_Adapter.MyMmzHolder> {
    private List<Belle_MMZ_Bean.ServerInfoBean.CoverPhotoDetailsInfoBeanX.CoverPhotoDetailsInfoBean> mlist;
    private Context mcontext;

    public Belle_Mmz_Adapter(List<Belle_MMZ_Bean.ServerInfoBean.CoverPhotoDetailsInfoBeanX.CoverPhotoDetailsInfoBean> mlist, Context mcontext) {
        this.mlist = mlist;
        this.mcontext = mcontext;
    }

    public void setMlist(List<Belle_MMZ_Bean.ServerInfoBean.CoverPhotoDetailsInfoBeanX.CoverPhotoDetailsInfoBean> mlist) {
        this.mlist = mlist;
    }

    @Override

    public MyMmzHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(mcontext).inflate(R.layout.zuixin_item, null);
        MyMmzHolder myxinHolder = new MyMmzHolder(inflate);
