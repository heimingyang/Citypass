...
public class MingRenTangAdapter extends RecyclerView.Adapter<MingRenTangAdapter.MyViewHolder> {
    private List<MingRenTangBean.ServerInfoBean.InfoBean> mList;

    public MingRenTangAdapter(List<MingRenTangBean.ServerInfoBean.InfoBean> mList) {
        this.mList = mList;
    ...
    public void setNewData(List<MingRenTangBean.ServerInfoBean.InfoBean> mList){
        this.mList = mList;
        notifyDataSetChanged();
    }
    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View v = LayoutInflater.from(App.activity).inflate(R.layout.shequ_mingrentang_listview,null);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final MingRenTangBean.ServerInfoBean.InfoBean in = mList.get(position+3);
    ...
    class  MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            PengChangWangLinear= (LinearLayout) itemView.findViewById(R.id.MingRenTang_layout);
            ...
            touxiang= (CircleImageView) itemView.findViewById(R.id.MingRenTang_userImage);
